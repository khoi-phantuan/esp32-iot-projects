...
## 🛠 Implementation
### 1. Connecting to Wi-Fi testing
- Select the **'ESP32 Dev Module'** board at the project creating phase.
- Use the USB cable to connect the ESP32 board to your computer.
- Flash the source code in `main.cpp` onto the ESP32 chip by clicking on the **'Upload'** button (right arrow icon on the toolbar at the bottom of the window).
- Then, press the **'EN'** button on the board to restart the chip. 
- Right after that, the **'Serial Monitor'** window will appear automatically, or you can open it manually by clicking on the plug icon on the toolbar:
![](images/connect_to_wi-fi.png)
...
![](images/disconnect_from_wi-fi.png)
